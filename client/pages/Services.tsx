...
const Services = () => {
  const services = [
    {
      title: 'Cloud & DevOps',
      description: 'Solutions de cloud computing et DevOps pour moderniser votre infrastructure IT',
      icon: Server,
    ...
    {
      title: 'QA & Testing',
      description: 'Services de test et assurance qualité pour garantir la fiabilité de vos applications',
      icon: TestTube,
      gradient: 'from-emerald-500 to-cyan-400',
      iconBg: '🧪',
    },
    {
      title: 'Engineer Digital',
      description: 'Solutions d\'ingénierie numérique pour transformer votre entreprise',
      icon: Code,
