                ...
                <svg className="w-full h-full" viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <pattern id="map-dots" patternUnits="userSpaceOnUse" width="20" height="20">
                      <circle cx="10" cy="10" r="1" fill="#007BFF" opacity="0.3" />
                    </pattern>
                  </defs>
              ...
              <div className="absolute top-8 left-8">
                <div className="service-card p-4 rounded-lg max-w-xs">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-white text-sm font-medium">Paul Gober</p>
              ...
              <div className="absolute top-4 right-16">
                <div className="service-card p-4 rounded-lg max-w-xs">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-white text-sm font-medium">Anna Hazeco</p>
                      <p className="text-gray-400 text-xs">Designer</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="absolute bottom-12 right-8">
                <div className="service-card p-4 rounded-lg max-w-xs">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-white text-sm font-medium">Ryan Olggs</p>
                      <p className="text-gray-400 text-xs">Designer</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-2 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-scc-blue-500 to-tech-cyan rounded-lg flex items-center justify-center">
              ...
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                Donec viverra accumsan cursus ut lorem justo vehicula nequat ornare donec. 
                Maecenas pharetra eros nulla consequat venenatis in condimentum sit tortor vehicula.
              </p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Tunis Sfax social - Centre El Maek - D & F 1973 - Montpellier - Tunisie - Tunisie
                  </p>
                </div>
                
                <div className="flex items-center gap-2">
                  <Mail size={16} className="text-scc-blue-500" />
                  <span className="text-gray-300 text-sm">scc@scc-tunisie.com</span>
                </div>
