...
import { MapPin, Mail, Phone, Fax } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 bg-navy-800 border border-scc-blue-500/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-scc-blue-500 focus:ring-2 focus:ring-scc-blue-500/20 transition-all duration-200 resize-none"
