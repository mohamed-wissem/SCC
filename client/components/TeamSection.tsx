  ...
  const services = [
    {
      title: "Guarantee",
      description:
        "Why Choose us semper risus in hendrerit gravida rutrum quisque.",
      icon: Shield,
              ...
              {teamStats.map((stat, index) => (
                ...
                >
                  <div className="text-2xl font-bold text-gradient mb-1">
                    {stat.number}
                    <span className="text-scc-blue-500">{stat.suffix}</span>
                  </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-8">
                Why Choose us semper risus in hendrerit gravida rutrum quisque.
                Pulvinar neque laoreet suspendisse interdum nibh tortor id
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="mb-4">
                    <div
                      className={`w-12 h-12 rounded-lg bg-gradient-to-br ${service.color} p-3 flex items-center justify-center group-hover:animate-pulse-glow`}
                    >
      ...
      >
        <defs>
          ...
          >
            ...
            <path
              d="M30 15v10M30 35v10M15 30h10M35 30h10"
              stroke="#007BFF"
              strokeWidth="1"
            />
          </pattern>
